...
<body>
    ...
    <div class="container">
        ...
        <div id="instructors" class="tab-content active">
            ...
            <?php if($pending->count() > 0): ?>
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $pending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($instructor->name); ?></td>
                                <td><?php echo e($instructor->email); ?></td>
                                <td><span class="badge badge-pending"><?php echo e(ucfirst($instructor->status)); ?></span></td>
                                <td>
                                    <div class="action-buttons">
                                        <form action="<?php echo e(route('instructors.approve', $instructor->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
            ...
            <?php if($approved->count() > 0): ?>
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $approved; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($instructor->name); ?></td>
                                <td><?php echo e($instructor->email); ?></td>
                                <td><span class="badge badge-approved"><?php echo e(ucfirst($instructor->status)); ?></span></td>
                                <td>
                                    <form action="<?php echo e(route('instructors.destroy', $instructor->id)); ?>" method="POST" style="display:inline;">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-primary btn-sm" onclick="openEditCourseModal(<?php echo e($course->id); ?>)">Edit</button>
        ...
        <div id="lessons" class="tab-content">
            ...
            <?php if($courses->count() > 0): ?>
                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <h3 style="margin-top: 25px; margin-bottom: 15px;"><?php echo e($course->title); ?></h3>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $course->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><strong><?php echo e($lesson->title); ?></strong></td>
                                        <td><?php echo e(Str::limit($lesson->content, 50)); ?></td>
                                        <td>
                                            <div class="action-buttons">
                                                <button class="btn btn-primary btn-sm" onclick="openEditLessonModal(<?php echo e($lesson->id); ?>)">Edit</button>
                                                <form action="<?php echo e(route('courses.lessons.destroy', [$course->id, $lesson->id])); ?>" method="POST" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</button>
                                                </form>
                    ...
                    <?php endif; ?>
                    <button class="btn btn-primary" onclick="openAddLessonModal(<?php echo e($course->id); ?>)" style="margin-top: 10px;">+ Add Lesson</button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
...
<?php /**PATH C:\Users\tanvi\Desktop\HungryBird\laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
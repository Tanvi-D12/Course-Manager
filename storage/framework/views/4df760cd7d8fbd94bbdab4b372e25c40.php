        ...
        <?php if($courses->count() > 0): ?>
            ...
            <div class="courses-grid" id="coursesGrid">
                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="course-card" data-course="<?php echo e(strtolower($course->title)); ?> <?php echo e(strtolower($course->instructor->name ?? '')); ?>">
                        <div class="course-header">
                            <h3 class="course-title"><?php echo e($course->title); ?></h3>
                        </div>
                        <div class="course-content">
                            <div class="course-instructor">
                                <?php echo e($course->instructor->name ?? 'Unknown Instructor'); ?>

                            </div>
                            <p class="course-description"><?php echo e(Str::limit($course->description, 120)); ?></p>
                            <div class="lesson-count">
                                <?php echo e($course->lessons->count()); ?> <?php echo e(Str::plural('lesson', $course->lessons->count())); ?>

                            </div>
                            <div class="course-actions">
                                <a href="/courses/<?php echo e($course->id); ?>" class="course-btn btn-view">View Details</a>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\tanvi\Desktop\HungryBird\laravel\resources\views/user/courses/index.blade.php ENDPATH**/ ?>
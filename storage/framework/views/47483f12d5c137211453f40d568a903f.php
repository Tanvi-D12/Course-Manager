...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'HungryBird'); ?> - Course Management</title>
        ...
        <div class="container">
            ...
            <nav>
                ...
                <?php if(request()->is('admin/*')): ?>
                    <a href="<?php echo e(route('admin.instructors.index')); ?>">Instructors</a>
                    <a href="<?php echo e(route('admin.courses.index')); ?>">Manage Courses</a>
                <?php endif; ?>
            </nav>
        </div>
    </header>
...
<?php /**PATH C:\Users\tanvi\Desktop\HungryBird\laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>